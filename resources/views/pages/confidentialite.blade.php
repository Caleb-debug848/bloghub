...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-gradient-to-br from-blue-500 to-green-500 rounded-2xl p-10 text-center mb-10">
        <h1 class="text-4xl font-bold text-white mb-3">Politique de Confidentialité</h1>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8">
        ...
        <div>
            ...
            <p class="text-gray-600 leading-relaxed">
                BlogHub collecte uniquement les données nécessaires au bon fonctionnement de la plateforme : 
                nom, adresse email et mot de passe lors de l'inscription. Ces informations sont utilisées 
                exclusivement pour vous identifier et personnaliser votre expérience.
            </p>
        </div>
        ...
        <div>
            ...
            <p class="text-gray-600 leading-relaxed">
                Vos données personnelles sont utilisées pour : créer et gérer votre compte, 
                publier vos articles et commentaires, vous envoyer des notifications importantes 
                concernant votre compte. Nous ne vendons jamais vos données à des tiers.
            </p>
        </div>
        ...
        <div>
            ...
            <p class="text-gray-600 leading-relaxed">
                BlogHub utilise des cookies de session pour maintenir votre connexion active. 
                Ces cookies sont essentiels au fonctionnement du site et ne collectent aucune 
                information personnelle supplémentaire.
            </p>
        </div>
        ...
        <div>
            ...
            <p class="text-gray-600 leading-relaxed">
                Vos mots de passe sont chiffrés avec l'algorithme bcrypt. Nous mettons en place 
                des mesures de sécurité régulières pour protéger vos données contre tout accès 
        ...
        <div>
            ...
            <p class="text-gray-600 leading-relaxed">
                ...
                à tout moment depuis votre espace profil. Pour toute demande, contactez-nous à 
        ...
        <div class="bg-blue-50 rounded-xl p-5">
            <p class="text-blue-700 text-sm">
                📧 Pour toute question relative à votre vie privée, contactez notre équipe à 
