        ...
        <div x-data="{ tab: 'articles' }">
            ...
            <div x-show="tab === 'articles'">
                <div class="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
                    <div class="flex justify-between items-center px-4 lg:px-6 py-4 border-b border-gray-100">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex gap-2">
                                            <form method="POST" action="{{ route('admin.posts.approuver', $post->id) }}">
                                                @csrf @method('PUT')
                                                <button class="bg-green-100 text-green-600 px-3 py-1 rounded-lg text-sm font-semibold hover:bg-green-200">Approuver</button>
                                            </form>
                                            <form method="POST" action="{{ route('admin.posts.rejeter', $post->id) }}">
                                                @csrf @method('PUT')
                                                <button class="bg-red-100 text-red-600 px-3 py-1 rounded-lg text-sm font-semibold hover:bg-red-200">Rejeter</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr class="border-t border-gray-100 hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <form method="POST" action="{{ route('admin.users.role', $user->id) }}" class="flex gap-2">
                                            ...
                                            <button class="bg-blue-100 text-blue-600 px-3 py-1 rounded-lg text-sm font-semibold hover:bg-blue-200">✓</button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
